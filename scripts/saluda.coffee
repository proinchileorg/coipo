  ...
  # robot.hear /hola/i, (msg) -> #test local
    if msg.message.room == 'anuncios'
      robot.emit 'slack.attachment', {channel: msg.message.user.name, text: """
        ...
        Recuerda leer nuestro <http://www.devschile.cl/coc/|Código de Conducta>. Cualquier duda o consulta sobre el CoC o el Slack puedes hacerla en <#C0TFU7ZJA|comunidad>.
